...
int usuarioImc(int imc, string decisioonEjercicio, int enfoquee,float pesoLibras,int numAleatorioo){
    float hacerLLegar;
    int cantidadCaloriaas;
    cantidadCaloriaas = imc * 85;
    ...
    if(enfoquee == 1){
        if(decisioonEjercicio == "si"){
            cantidadCaloriaas = cantidadCaloriaas + 200;
        }else{
            cantidadCaloriaas = cantidadCaloriaas - 200;
        }
    }else if(enfoquee == 3){
        if(pesoLibras < 150){
            if(decisioonEjercicio == "si"){
                cantidadCaloriaas = cantidadCaloriaas + 1000;
            }else{
                cantidadCaloriaas = cantidadCaloriaas + 1500;
            }
        }
        else{
            if(decisioonEjercicio == "si"){
    ...
    cout<<"el siguiente menu fue personalizado de a cuerdo con tus calorias"<<endl<<endl;
...
int main()
{
    ...
    if(decisionUsuario == 2){
    ...
    else if(decisionUsuario == 1){
        cout<< "Ingrese su peso en libras: ";
        cin>>pesolb;
        cout<< "Ingrese su altura en metros: ";
        cin>>altura;
        while(altura > 3){
            cout<<"Ingresa tu altura en metros, por ejemplo si mides 180 cm, es 1.8m..."<<endl;
            cin>>altura;
        }
        peso=pesolb/2.2046;
        ...
        usuarioImc(imc, decisionEjercicio, enfoque,pesolb,numAleatorio);
        }
    return 0;
}
